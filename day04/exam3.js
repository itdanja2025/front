...
// vs 삼항연산자 : 
// 1. 다양한 논리 할때 가독성 떨어진다
// 2. true 와 false (항) 함수호출 또는 변수선언 불가능하다 

// 10 > 5 ? console.log("참"); : console.log("거짓"); [오류]
...
if( 15 > 10 ){ console.log( "[4-3] 참3 "); } // [4-3] 참3  
if( 15 > 5 ){ console.log( "[4-4] 참4"); }  // [4-4] 참4
else{ console.log("[4-5] 그외(거짓) "); }
